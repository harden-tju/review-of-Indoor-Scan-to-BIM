...
- [GeoBIM for built environment condition assessment supporting asset management decision making (Moretti2021, Automation in Construction)](http://doi.org/10.1016/j.autcon.2021.103859)
- [Cultural heritage characteristics and damage analysis based on multidimensional data fusion and HBIM-taking the former residence of HSBC bank in Xiamen, China as an example (Zhou2024, Heritage Science)](http://doi.org/10.1186/s40494-024-01238-w)
- [HBIM for Conservation of Built Heritage (Alshawabkeh2024, ISPRS International Journal of Geo-Information)](http://doi.org/10.3390/ijgi13070231)
- [AI BIM coordinator for non-expert interaction in building design using LLM-driven multi-agent systems (Dong2025, Automation in Construction)](http://doi.org/10.1016/j.autcon.2025.106563)
